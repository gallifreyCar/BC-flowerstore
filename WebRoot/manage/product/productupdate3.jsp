                    ...
                    <form action="${url }" method="post" onsubmit="return checkform()">
                        ...
                        <TABLE cellSpacing=0 cellpadding="5" width="100%" align=center border=1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="jiage" id="jiageid" value="${bean.dianjishu }"
                                           readonly="readonly"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="jiage" id="jiageid" value="${bean.xiaoliang }"
                                           readonly="readonly"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="jiage" id="jiageid" value="${bean.tuijian }"
                                           readonly="readonly"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                        <textarea rows="7" cols="50" name="miaoshu"
                                                  readonly="readonly">${bean.miaoshu }</textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input onclick="javascript:history.go(-1);" style="width: 60px" type="button"
                                           value="返回"/>
                                </td>
                            </tr>
